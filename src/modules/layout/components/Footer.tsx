...
export default function Footer() {
  ...
  return (
    <footer className="bg-gradient-to-b from-white to-lilac-50 border-t border-gray-200">
      <div className="max-w-7xl mx-auto pt-12 pb-8 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8 mb-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-sm text-gray-600 mb-6 max-w-md">
              We offer premium tech products and accessories that enhance your digital lifestyle. Quality, innovation, and exceptional customer service are at the core of everything we do.
            </p>
        ...
        <div className="flex flex-col md:flex-row md:justify-between md:items-center pt-8 border-t border-gray-200 text-sm text-gray-500">
          <p>&copy; {currentYear} AndMore. All rights reserved.</p>
          <div className="mt-4 md:mt-0 flex flex-wrap gap-x-8">
